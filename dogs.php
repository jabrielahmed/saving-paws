      ...
      <div class="row">
        <div class="col-md-12">
          <div class="we-are-my-pet-text"> <span></span>
			...
			foreach($dogs as $dog){
				?><img src="<?php echo($dog["Picture"]); ?>" alt="A dog" class="float-left" height="225">
					...
					<div class="row our-pet-services">
						<div class="col-md-3 col-sm-6 col-xs-12">
							...
							<div class="pet-overlay">
								<div class="overlay-pet-services-img">
									<img src="images/home/img-3.jpg" alt="image">
								</div>
								<div class="overlay-services-text">
									<h5><a href="pet1-details.html">PET GROOMING</a></h5>
									<p>Puppy : <span>Male</span></p>
									<p>Yigo</p>
								</div>
							</div>
						</div>
