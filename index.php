...
<section>
      ...
      <div data-src="images/home/banner-slider-1.jpg">
        <div class="camera_caption">
          <div class="container text-center">
            ...
            <a href="adoptions.php" class="tran3s wow fadeInRight animated banner-button-right" data-wow-delay="1s">Get Pet</a> </div>
          <!-- /.container --> 
        </div>
        <!-- /.camera_caption --> 
      </div>
      <div data-src="images/home/banner-slider-2.jpg">
        <div class="camera_caption">
          <div class="container text-center">
            ...
            <a href="adoptions.php" class="tran3s wow fadeInRight animated banner-button-right" data-wow-delay="1s">Learn More!</a> </div>
          <!-- /.container --> 
        </div>
        <!-- /.camera_caption --> 
      </div>
  ...
  <section class="our-pet-services-section">
    <div class="container">
      <div class="them-title text-center"> <span></span>
        ...
        <div class="col-md-4 col-xs-6 our-pet-services-item-width">
          <div class="our-pet-services-item">
            <div class="our-pet-services-img">
				<img src="images/home/img-2.jpg" alt="image"> <a href="s-p-a-r-k-e-d-program.php"></a>
			</div>
            <div class="our-pet-services-text">
              <h5><a href="s-p-a-r-k-e-d-program.php">S.P.A.R.K.E.D</a></h5>
              <p>Saving Paws Animal Rescue K-9's empowering the disabled.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-xs-6 our-pet-services-item-width">
          <div class="our-pet-services-item">
            <div class="our-pet-services-img">
				<img src="images/home/img-3.jpg" alt="image"><a href="adoptions.php"></a>
			</div>
            <div class="our-pet-services-text">
              <h5><a href="adoptions.php">ADOPT</a></h5>
              <p>We have so many great animals waiting for their new families to find them. Today could be the day.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-xs-6 our-pet-services-item-width">
          <div class="our-pet-services-item">
            <div class="our-pet-services-img">
				<img src="images/home/img-4.jpg" alt="image"><a href="become-a-rescue-volunteer.php"></a> 
			</div>
            <div class="our-pet-services-text">
              <h5><a href="become-a-rescue-volunteer.php">VOLUNTEER</a></h5>
              <p>Volunteers are our lifeline. See how you can help.</p>
            </div>
          </div>
        </div>
      </div>
