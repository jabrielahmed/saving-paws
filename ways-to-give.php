        ...
        <div class="col-md-12">
          <div class="we-are-my-pet-text"> <span><br></span>
			  <div class="col-sm-10">
				...
				<p>Saving Paws Animal Rescue is a non-profit animal rescue organization with IRS 501(c)(3) charitable status. You can help the dogs and cats in our care with donations of cash or goods. We appreciate cash donations of any size, and they all help the pets in our care.</p>
			  <ul class="listing">
				  <li>
				    <p>We are a no-kill rescue, and we do not receive any   county, state or public funding. We rely solely on compassionate people   like you to help us care for our rescued animal. </p>
			    </li>
				  <li>
				    <p>When you make an unrestricted or undesignated donation, you trust us to use your gift in the areas most in need of support.</p>
			    </li>
				  <li>
				    <p>You can make designated or restricted gifts, where   you specify the target expenditure. For example, you may wish to have   your gift go to dogs or cats, or to dog medical care or cat medical   care.</p>
			    </li>
				  <li>
				    <p>Our staff is 100% volunteers, so you can rest assured knowing every dollar you give goes directly to our animals. </p>
			    </li>
				  <li>
				    <p>You can make a donation in honor of or in memory of a   special someone or pet who is dear to your heart or who has made a   difference in the lives of homeless pets.</p>
			    </li>
			  </ul>
			</div>
		    ...
		    <p>Whatever the nature of your gift, you will have the assurance that your support will be used directly to our mission of saving, rehabilitating, and adopting homeless pets: veterinary fees, pet food and medication, and adoption event fees.</p>
			  <p>Click the DONATE to make your own IN HONOR OF OR IN   MEMORY OF donation! Please note that you must first put in your donation   amount and click &ldquo;update total&rdquo; before entering in your contact info.<br>
			  ...
			  <p>Scooter G Sports in Appleton is now a donation drop off location for Saving Paws! At 129 E. College Ave. Appleton  Phone: (920)257-4058.</p>
          </div>
        </div>
      </div>
    </div>
